...
export class ApprovalguarantordetailComponent extends BaseComponent implements OnInit {
  // get param from url
  ...
  public approvalguarantordetailData: any = [];
  ...
  //#region  form submit
  onFormSubmit(approvalguarantordetailForm: NgForm, isValid: boolean) {
    ...
    this.approvalguarantordetailData = approvalguarantordetailForm;
    if (this.approvalguarantordetailData.p_gender_code == null) {
      this.approvalguarantordetailData.p_gender_code = this.genderCode;
    }
    this.approvalguarantordetailData = this.JSToNumberFloats(approvalguarantordetailForm);
    const usersJson: any[] = Array.of(this.approvalguarantordetailData);
    if (this.params != null) {
      // call web service
        ...
        .subscribe(
          res => {
            ...
            if (parse.result === 1) {
              ...
              $('#clientDetail').click();
              this.showNotification('bottom', 'right', 'success');
              this.route.navigate(['/inquiry/subapplicationmainlist/applicationmaindetail/' + this.param + '/legaldetail/' + this.param + '/' + this.branch + '/approvalguarantordetail/', this.param, parse.id], { skipLocationChange: true });
            } else {
              this.showSpinner = false;
              this.swalPopUpMsg(parse.data);
            }
