...
export class ApprovalsurveyrequestlistComponent extends BaseComponent implements OnInit {
  // get param from url
  param = this.getRouteparam.snapshot.paramMap.get('id');
  pageType = this.getRouteparam.snapshot.paramMap.get('page');

  // variable
  public listapprovalsurveyrequest: any = [];
    ...
    this.dtOptions = {
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRows).subscribe(resp => {
          ...
          this.listapprovalsurveyrequest = parse.data;
          if (parse.data != null) {
            this.listapprovalsurveyrequest.numberIndex = dtParameters.start;
          }
