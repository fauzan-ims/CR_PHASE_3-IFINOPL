...
@Component({
  moduleId: module.id,
  selector: 'app-root',
  templateUrl: './applicationapprovallist.component.html',
})

export class ApplicationapprovallistComponent extends BaseComponent implements OnInit {
  // variable
  public listapplicationapproval: any = [];
  ...
  ngOnInit() {
    ...
    this.tampGetrows = this.APIRouteForGetRowsApproval;
    ...
    this.dtOptions = {
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        this.dalservice.Getrows(dtParameters, this.APIController, this.tampGetrows).subscribe(resp => {
          ...
          this.listapplicationapproval = parse.data;
          if (parse.data != null) {
            this.listapplicationapproval.numberIndex = dtParameters.start;
          }
          callback({
            draw: parse.draw,
  ...
  btnEdit(codeEdit: String) {
    ...
    this.route.navigate(['/application/banberjalanapplicationmain/applicationmaindetail', codeEdit, 'banberjalan']);
  }
