...
export class AssetinsurancedetaildetailComponent extends BaseComponent implements OnInit {
    // get param from url
    ...
    onFormSubmit(assetinsurancedetaildetailForm: NgForm, isValid: boolean) {
        ...
        if (this.assetinsuranceData.p_is_tbod === undefined) {
            this.assetinsuranceData.p_is_tbod = 'F'
        }
