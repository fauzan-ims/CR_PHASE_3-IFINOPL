...
export class AssetlistComponent extends BaseComponent implements OnInit {
  ...
  //#region button add
  btnAdd() {
    this.route.navigate(['/application/subapplicationmainlist/applicationmaindetail/' + this.param + '/assetlist/' + this.param + '/assetdetail/', this.param], { skipLocationChange: true });
  }
  ...
  btnEdit(codeEdit: string) {
    if (this.pageType != null) {
      ...
      this.route.navigate(['/application/subapplicationmainlist/applicationmaindetail/' + this.param + '/assetlist/' + this.param + '/assetdetail/', this.param, codeEdit], { skipLocationChange: true });
    }
  }
