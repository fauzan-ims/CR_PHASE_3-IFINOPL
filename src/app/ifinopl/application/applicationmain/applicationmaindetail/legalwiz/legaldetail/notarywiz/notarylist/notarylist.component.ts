...
export class NotarylistComponent extends BaseComponent implements OnInit {
  // get param from url
  ...
  //#region button add
  btnAdd() {
    this.route.navigate(['/application/subapplicationmainlist/applicationmaindetail/' + this.param + '/legaldetail/' + this.param + '/' + this.branch + '/notarydetail/', this.param, this.branch], { skipLocationChange: true });
  }
  ...
  btnEdit(codeEdit: string) {
    if (this.pageType != null) {
      this.route.navigate(['/application/banberjalanapplicationmain/applicationmaindetail/' + this.param + '/' + this.pageType + '/legaldetail/' + this.param + '/' + this.branch + '/' + 'banberjalan' + '/notarydetail/', this.param, codeEdit, this.branch, 'banberjalan'], { skipLocationChange: true });
    } else {
      this.route.navigate(['/application/subapplicationmainlist/applicationmaindetail/' + this.param + '/legaldetail/' + this.param + '/' + this.branch + '/notarydetail/', this.param, codeEdit, this.branch], { skipLocationChange: true });
    }
  }
