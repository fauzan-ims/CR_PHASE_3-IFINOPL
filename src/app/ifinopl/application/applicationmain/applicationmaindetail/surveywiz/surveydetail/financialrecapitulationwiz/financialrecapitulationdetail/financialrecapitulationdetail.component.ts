...
export class FinancialrecapitulationdetailComponent extends BaseComponent implements OnInit {
  ...
  public listfinancialrecapitulationdetailData: any = [];
        ...
        .subscribe(
          res => {
            ...
            if (parse.result === 1) {
              ...
              this.showNotification('bottom', 'right', 'success');
              this.route.navigate(['/application/subapplicationmainlist/applicationmaindetail/' + this.param + '/surveydetail/' + this.param + '/financialrecapitulationdetail/', this.param, parse.code], { skipLocationChange: true });
            } else {
              this.showSpinner = false;
              this.swalPopUpMsg(parse.data);
            }
  ...
  btnBack() {
    if (this.pageType != null) {
      ...
      this.route.navigate(['/application/subapplicationmainlist/applicationmaindetail/' + this.param + '/surveydetail/' + this.param + '/financialrecapitulationlist', this.param], { skipLocationChange: true });
    }
  ...
  btnSaveList() {
    this.showSpinner = true;
    this.listfinancialrecapitulationdetailData = [];
    ...
    while (i < getID.length) {
      ...
      while (i < getFromAmount.length) {
        ...
        while (i < getToAmount.length) {
          ...
          this.listfinancialrecapitulationdetailData.push(
    ...
    //#region web service
    // tslint:disable-next-line:max-line-length
    this.dalservice.Update(this.listfinancialrecapitulationdetailData, this.APIControllerApplicationFinancialRecapitulationDetail, this.APIRouteForUpdate)
      .subscribe(
        res => {
          const parse = JSON.parse(res);
          if (parse.result === 1) {
