...
export class FinancialrecapitulationlistComponent extends BaseComponent implements OnInit {
  // get param from url
  ...
  //#region button add
  btnAdd() {
    this.route.navigate(['/application/subapplicationmainlist/applicationmaindetail/' + this.param + '/surveydetail/' + this.param + '/financialrecapitulationdetail/', this.param], { skipLocationChange: true });
  }
  ...
  btnEdit(codeEdit: string) {
    if (this.pageType != null) {
      ...
      this.route.navigate(['/application/subapplicationmainlist/applicationmaindetail/' + this.param + '/surveydetail/' + this.param + '/financialrecapitulationdetail/', this.param, codeEdit], { skipLocationChange: true });
    }
  }
