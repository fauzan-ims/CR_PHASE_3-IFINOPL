...
export class ApplicationmainlistComponent extends BaseComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.tampGetrows = this.APIRouteForGetRows;
  ...
  //#region button add
  btnAdd() {
    this.route.navigate(['/application/subapplicationmainlist/applicationmaindetail']);
  }
  //#endregion button add

  //#region button edit
  btnEdit(codeEdit: String) {
    this.route.navigate(['/application/subapplicationmainlist/applicationmaindetail', codeEdit]);
  }
