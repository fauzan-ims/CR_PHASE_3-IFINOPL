...
@Component({
  moduleId: module.id,
  selector: 'app-root',
  templateUrl: './applicationpdcregisterlist.component.html',
})

export class ApplicationPdcRegisterlistComponent extends BaseComponent implements OnInit {
  // variable
  ...
  private APIRouteForGetRowsPDC: String = 'GetRowsPDC';
  ...
  loadData() {
    this.dtOptions = {
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRowsPDC).subscribe(resp => {
  ...
  btnEdit(codeEdit: String) {
    this.route.navigate(['/application/subapplicationpdclist/applicationpdcregisterdetail', codeEdit]);
  }
