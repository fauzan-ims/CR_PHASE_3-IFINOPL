...
@Component({
  moduleId: module.id,
  selector: 'app-root',
  templateUrl: './applicationtbodocumentlist.component.html',
})

export class ApplicationTboDocumentlistComponent extends BaseComponent implements OnInit {
  // variable
  ...
  private APIRouteForGetRowsTBODocument: String = 'GetRows';
  ...
  btnEdit(codeEdit: String) {
    this.route.navigate(['/application/subtbodocumentlist/tbodocumentdetail', codeEdit]);
  }
