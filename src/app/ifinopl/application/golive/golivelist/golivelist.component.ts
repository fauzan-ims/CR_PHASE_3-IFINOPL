...
@Component({
  moduleId: module.id,
  selector: 'app-root',
  templateUrl: './golivelist.component.html',
})

export class GolivelistComponent extends BaseComponent implements OnInit {
  // variable
  public listgolive: any = [];
  ...
  private APIRouteForGetRows: String = 'GetRowsGolive';
    ...
    this.dtOptions = {
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRows).subscribe(resp => {
          ...
          this.listgolive = parse.data;
          if (parse.data != null) {
            this.listgolive.numberIndex = dtParameters.start;
          }
          callback({
            draw: parse.draw,
  ...
  btnEdit(codeEdit: String) {
    this.route.navigate(['/application/subgolivelist/golivedetail', codeEdit]);
  }
