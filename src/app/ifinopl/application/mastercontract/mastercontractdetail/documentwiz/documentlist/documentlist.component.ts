    ...
    this.dalservice.Getrow(this.dataTamp, this.APIControllerApplication, this.APIRouteForGetRow)
      .subscribe(
        res => {
          ...
          // this.isValidate = parsedata.is_valid;
...
    );
  ...
  //#region isValid
  isValid(event: any, remark: any, id: any, received: any) {
    this.showSpinner = true;
  ...
  //#endregion isValid
    ...
    //#region isReceived
  isReceived(event: any, remark: any, id: any, isValid:any) {
    this.showSpinner = true;
  ...
  //#region isValid
  saveRemarks(event: any, isValid: any, id: any, received:any ) {
    this.showSpinner = true;
