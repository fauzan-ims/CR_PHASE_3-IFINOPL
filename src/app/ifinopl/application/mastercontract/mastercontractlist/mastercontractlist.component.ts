...
@Component({
  moduleId: module.id,
  selector: 'app-root',
  templateUrl: './mastercontractlist.component.html',
})

export class MastercontractlistComponent extends BaseComponent implements OnInit {
  // variable
  public listapplicationmain: any = [];
  public lookupsysbranch: any = [];
  public branch_name: String;
  public branch_code: String;
  public tempIsValid: String;

  private APIController: String = 'ApplicationMain';
  private APIControllerSysBranch: String = 'SysBranch';

  private APIRouteForGetRowsTBODocument: String = 'GetRowsTBODocument';
  private APIRouteForGetRowsApplicationExtention: String = 'GetRowsForApplicationExtention';
  ...
  //#region isValid
  isValid(event) {
    this.tempIsValid = event.target.value;
    ...
    this.dtOptions = {
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        dtParameters.paramTamp.push({
          ...
          'p_is_valid': this.tempIsValid
        })

        this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRowsApplicationExtention).subscribe(resp => {
  ...
  btnEdit(codeEdit: String) {
    this.route.navigate(['/application/subapplicationtbodocumentlist/applicationtbodocumentdetail', codeEdit]);
  }
