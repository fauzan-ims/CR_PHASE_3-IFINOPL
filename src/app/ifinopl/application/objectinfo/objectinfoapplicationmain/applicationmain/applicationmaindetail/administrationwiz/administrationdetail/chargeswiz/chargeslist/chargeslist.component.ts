...
export class ObjectInfoChargeslistComponent extends BaseComponent implements OnInit {
  // get param from url
  ...
  btnEdit(codeEdit: string) {
      this.route.navigate(['/objectinfoapplication/objectinfoapplicationmain/' + this.param + '/' + this.pageType + '/administrationdetail/' + this.param + '/' + 'banberjalan' + '/chargesdetail/', this.param, codeEdit, 'banberjalan'], { skipLocationChange: true });
  }
