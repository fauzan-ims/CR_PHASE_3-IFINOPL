...
export class ObjectInfoFeedetailComponent extends BaseComponent implements OnInit {
  // get param from url
  ...
  //#region button back
  btnBack() {
    this.route.navigate(['/objectinfoapplication/objectinfoapplicationmain/' + this.param + '/' + this.pageType + '/administrationdetail/' + this.param + '/' + 'banberjalan' + '/feelist/', this.param, 'banberjalan'], { skipLocationChange: true });
