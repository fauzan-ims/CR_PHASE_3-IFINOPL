...
export class ObjectInfoKaroseriaccessorieslistinquiryComponent extends BaseComponent implements OnInit {
  ...
  btnBack() {
    ...
    //this.route.navigate(['/objectinfoapplication/objectinfoapplicationmain/' + this.param + '/' + this.pageType + '/assetlist/' + this.param + '/' + 'banberjalan' + '/assetdetail/', this.param, codeEdit, 'banberjalan'], { skipLocationChange: true });
    // this.route.navigate(['/application/subapplicationmainlist/applicationmaindetail/' + this.appNo + '/assetlist/' + this.appNo + '/assetdetail/', this.appNo, this.assetNo], { skipLocationChange: true });
  }
  //#endregion btn back
