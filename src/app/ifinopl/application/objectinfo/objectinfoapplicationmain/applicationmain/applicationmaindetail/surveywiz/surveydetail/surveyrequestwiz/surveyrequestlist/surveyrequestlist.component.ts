...
export class ObjectInfoSurveyrequestlistComponent extends BaseComponent implements OnInit {
  // get param from url
  ...
  btnEdit(codeEdit: string) {
    this.route.navigate(['/objectinfoapplication/objectinfoapplicationmain/' + this.param + '/' + this.pageType + '/surveydetail/' + this.param + '/' + 'banberjalan' + '/surveyrequestdetail/', this.param, codeEdit, 'banberjalan'], { skipLocationChange: true });
  }
