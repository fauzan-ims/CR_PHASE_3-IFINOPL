...
@Component({
    selector: 'app-invoicedelivery',
    templateUrl: './invoicedeliverylist.component.html'
})
export class InvoiceDeliverylistComponent extends BaseComponent implements OnInit {
    // variable
    public lookupbranch: any = [];
    public listinvoicedelivery: any = [];
        ...
        this.dtOptions = {
            ...
            ajax: (dtParameters: any, callback) => {
                ...
                this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRows).subscribe(resp => {
                    ...
                    this.listinvoicedelivery = parse.data;
                    if (parse.data != null) {
                        this.listinvoicedelivery.numberIndex = dtParameters.start;
                    }
    ...
    //#region button add
    btnAdd() {
        this.route.navigate(['/billing/subdeliverylist/deliverydetail']);
    }
    //#endregion button add

    //#region button edit
    btnEdit(codeEdit: string) {
        this.route.navigate(['/billing/subdeliverylist/deliverydetail', codeEdit]);
    }
