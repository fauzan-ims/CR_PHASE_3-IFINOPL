...
@Component({
  selector: 'app-pendingbillingagreementlist',
  templateUrl: './pendingbillingagreementlist.component.html'
})
export class PendingbillingagreementlistComponent extends BaseComponent implements OnInit {
  // variable
  ...
  public tampStatusInvoice: String;
  ...
  //#region ddl master module
  PageStatusInvoice(event: any) {
    this.tampStatusInvoice = event.target.value;
    $('#datatable').DataTable().ajax.reload();
  }
  //#endregion ddl master module
    ...
    this.dtOptions = {
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        dtParameters.paramTamp.push({
          ...
          'p_invoice_status': this.tampStatusInvoice
        });
  ...
  btnEdit(codeEdit: string) {
    this.route.navigate(['/billing/subpendingbillingagreementlist/pendingbillingagreementdetail', codeEdit]);
  }
