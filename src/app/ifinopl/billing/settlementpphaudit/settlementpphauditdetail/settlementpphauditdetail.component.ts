...
@Component({
  selector: 'app-settlementpphauditdetail',
  templateUrl: './settlementpphauditdetail.component.html'
})
export class SettlementpphauditdetailComponent extends BaseComponent implements OnInit {
  // get param from url
  settlementpphauditCode = this.getRouteparam.snapshot.paramMap.get('settlementpphauditcode');
  ...
  btnViewApproval() {
    ...
    $('#datatableLookupApproval').DataTable({
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        dtParameters.paramTamp = [];
        dtParameters.paramTamp.push({
          'p_reff_no': this.settlementpphauditCode
        });
