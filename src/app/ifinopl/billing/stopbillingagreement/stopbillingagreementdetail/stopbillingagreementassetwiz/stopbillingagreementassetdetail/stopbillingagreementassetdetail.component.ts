...
@Component({
  moduleId: module.id,
  selector: 'app-stopbillingagreementassetdetail',
  templateUrl: './stopbillingagreementassetdetail.component.html'
})

export class StopbillingagreementassetdetailComponent extends BaseComponent implements OnInit {
  // get param from url
  ...
  amortizationwiz() {
    ...
    this.route.navigate(['/billing/substopbillingagreementlist/stopbillingagreementassetdetail/' + this.param + '/' + this.params + '/stopbillingagreementamortizationlist/', this.param, this.params], { skipLocationChange: true });
  }
  ...
  //#region button back
  btnBack() {
    this.route.navigate(['/billing/substopbillingagreementlist/stopbillingagreementdetail', this.param], { skipLocationChange: true });
