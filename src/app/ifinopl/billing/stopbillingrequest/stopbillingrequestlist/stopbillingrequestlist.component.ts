...
@Component({
  moduleId: module.id,
  selector: 'app-stopbillingrequestlist',
  templateUrl: './stopbillingrequestlist.component.html',
})

export class StopbillingrequestlistComponent extends BaseComponent implements OnInit {
  // variable
  public liststopbilling: any = [];
    ...
    this.dtOptions = {
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRows).subscribe(resp => {
          ...
          this.liststopbilling = parse.data;
          if (parse.data != null) {
            this.liststopbilling.numberIndex = dtParameters.start;
          }
          callback({
            draw: parse.draw,
  ...
  //#region button add
  btnAdd() {
    this.route.navigate(['/billing/substopbillinglist/substopbillingdetail']);
  }
  //#endregion button add

  //#region button edit
  btnEdit(codeEdit: String) {
    this.route.navigate(['/billing/substopbillinglist/substopbillingdetail', codeEdit]);
  }
