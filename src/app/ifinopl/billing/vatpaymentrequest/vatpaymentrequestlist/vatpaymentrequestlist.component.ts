...
@Component({
  ...
  templateUrl: './vatpaymentrequestlist.component.html'
})

export class VatpaymentrequestlistComponent extends BaseComponent implements OnInit {
  // variable
  ...
  private APIRouteForGetRows: String = 'GetrowsForPayemntRequest';
  private APIRouteForLookup: String = 'GetRowsForLookup';
  private APIRouteForProceed: String = 'ExecSpProceedForVatPaymentRequest';

  private RoleAccessCode = 'R00020790000000A'; // role access 
