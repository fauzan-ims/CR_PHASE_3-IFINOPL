...
@Component({
    selector: 'app-withholdingpaymentdetail',
    templateUrl: './withholdingpaymentdetail.component.html'
})
export class WithholdingpaymentdetailComponent extends BaseComponent implements OnInit {
    // get param from url
    ...
    //Controller
    private APIController: String = 'InvoicePphPayment';
    private APIControllerSub: String = 'InvoicePphPaymentDetail';
    ...
    private APIRouteForProceed: String = 'ExecSpWithholdingPaymentProceed';
    private APIRouteForCancel: String = 'ExecSpPphPaymentCancel';
    ...
    //#region button back
    btnBack() {
        this.route.navigate(['/billing/subwihholdingpaymentlist']);
                    ...
                    .subscribe(
                        res => {
                            ...
                            if (parse.result === 1) {
                                this.callGetrow();
                                this.showNotification('bottom', 'right', 'success');
                                this.route.navigate(['/billing/subwihholdingpaymentlist/withholdingpaymentdetail/' + this.model.code]);
                            } else {
                                this.swalPopUpMsg(parse.data)
                            }
                        },
