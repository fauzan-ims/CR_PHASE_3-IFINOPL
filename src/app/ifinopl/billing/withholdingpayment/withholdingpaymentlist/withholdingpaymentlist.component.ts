...
@Component({
    selector: 'app-withholdingpaymentlist',
    templateUrl: './withholdingpaymentlist.component.html'
})
export class WithholdingpaymentlistComponent extends BaseComponent implements OnInit {
    // variable
    public listcode: any = [];
    ...
    private RoleAccessCode = 'R00020930000000A'; // role access 
    ...
    btnEdit(codeEdit: string) {
        this.route.navigate(['/billing/subwihholdingpaymentlist/withholdingpaymentdetail', codeEdit]);
    }
