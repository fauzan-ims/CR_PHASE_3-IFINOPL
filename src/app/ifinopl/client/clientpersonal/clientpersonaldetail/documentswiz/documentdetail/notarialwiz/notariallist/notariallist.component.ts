...
@Component({
  moduleId: module.id,
  selector: 'app-root',
  templateUrl: './notariallist.component.html'
})

export class NotariallistComponent extends BaseComponent implements OnInit {
  // get param from url
  ...
  //#region button add
  btnAdd() {
    this.route.navigate(['/client/subclientpersonallist/clientpersonaldetail/' + this.param + '/' + this.params + '/' + this.type + '/' + this.from + '/' + this.page + '/documentdetail/' + this.param + '/' + this.type + '/notarialdetail/', this.param], { skipLocationChange: true });
  }
  //#endregion button add

  //#region button edit
  btnEdit(codeEdit: string) {
    this.route.navigate(['/client/subclientpersonallist/clientpersonaldetail/' + this.param + '/' + this.params + '/' + this.type + '/' + this.from + '/' + this.page + '/documentdetail/' + this.param + '/' + this.type + '/notarialdetail/', this.param, codeEdit], { skipLocationChange: true });
  }
