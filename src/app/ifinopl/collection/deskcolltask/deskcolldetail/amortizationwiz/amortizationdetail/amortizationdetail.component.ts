...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './amortizationdetail.component.html'
})

export class AmortizationdetailComponent extends BaseComponent implements OnInit {
    // get param from url
    ...
    loadData() {
        this.dtOptions = {
            ...
            ajax: (dtParameters: any, callback) => {
                ...
                this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRowsAgreement).subscribe(resp => {
