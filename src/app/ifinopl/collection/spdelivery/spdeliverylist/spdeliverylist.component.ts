...
@Component({
  moduleId: module.id,
  selector: 'app-root',
  templateUrl: './spdeliverylist.component.html'
})

export class SpdeliverylistComponent extends BaseComponent implements OnInit {
  // #variable
  public listspdelivery: any = [];
    ...
    this.dtOptions = {
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        this.dalservice.Getrows(dtParameters, this.APIControllerSPDelivery, this.APIRouteForGetRows).subscribe(resp => {
          ...
          this.listspdelivery = parse.data;
          if (parse.data != null) {
            this.listspdelivery.numberIndex = dtParameters.start;
          }
          callback({
            draw: parse.draw,
  ...
  //#region button add
  btnAdd() {
    this.route.navigate(['/collection/subspdeliverylist/spdeliverydetail']);
  }
  //#endregion button add

  //#region button edit
  btnEdit(codeEdit: string) {
    this.route.navigate(['/collection/subspdeliverylist/spdeliverydetail', codeEdit]);
  }
