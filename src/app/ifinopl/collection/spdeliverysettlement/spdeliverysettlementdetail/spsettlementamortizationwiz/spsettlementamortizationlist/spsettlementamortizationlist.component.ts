...
@Component({
  moduleId: module.id,
  selector: 'app-root',
  templateUrl: './spsettlementamortizationlist.component.html'
})

export class SpSettlementAmortizationlistComponent extends BaseComponent implements OnInit {
  // get param from url
  ...
  btnEdit(codeEdit: string) {
    this.route.navigate(['/collection/subspdeliverysettlementlist/spdeliverysettlementdetail',this.param,'spsettlementamortizationdetail',this.param,codeEdit], { skipLocationChange: true });
  }
