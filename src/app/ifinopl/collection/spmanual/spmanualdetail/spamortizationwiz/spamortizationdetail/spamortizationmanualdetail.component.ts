...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './spamortizationmanualdetail.component.html'
})

export class SpAmortizationManualdetailComponent extends BaseComponent implements OnInit {
    // get param from url
    ...
    private RoleAccessCode = 'R00020990000000A'; // role access 
