...
export class DeliveryrequestlistComponent extends BaseComponent implements OnInit {
  ...
  private APIRouteForGetRows: String = 'GetRowsRealizationRequest';
  private APIRouteForLookup: String = 'GetRowsForLookup';
  private APIRouteForProceed: String = 'ExecSpForProceedRealizationRequest';
  private APIRouteForCancel: String = 'ExecSpForCancelRealization';
