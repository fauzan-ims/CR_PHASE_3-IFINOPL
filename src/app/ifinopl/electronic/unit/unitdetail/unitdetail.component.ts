...
export class UnitdetailComponent extends BaseComponent implements OnInit {
  ...
  private APIController: String = 'MasterElectronicUnit';
  private APIControllerCategory: String = 'MasterElectronicCategory';
  private APIControllerSub: String = 'MasterElectronicSubcategory';
  private APIControllerMerk: String = 'MasterElectronicMerk';
  private APIControllerModel: String = 'MasterElectronicModel';
  ...
  private RoleAccessCode = 'R00019960000000A'; // role access 
    ...
    $('#datatableLookupModel').DataTable({
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        dtParameters.paramTamp.push({
          'p_electronic_merk_code': this.model.electronic_merk_code,
          'p_electronic_subcategory_code': this.model.electronic_subcategory_code
        });
  ...
  btnSelectRowModel(code: String, description: String) {
    this.model.electronic_model_code = code;
    this.model.electronic_model_name = description;
    this.model.electronic_name = this.model.electronic_category_name + '-' + this.model.electronic_subcategory_name + '-' +
      this.model.electronic_merk_name + '-' + this.model.electronic_model_name;
  ...
  btnSelectRowMerk(code: String, description: String) {
    this.model.electronic_merk_code = code;
    this.model.electronic_merk_name = description;
    this.model.electronic_model_name = undefined;
    this.model.electronic_model_code = undefined;
    this.model.electronic_name = this.model.electronic_category_name + '-' + this.model.electronic_subcategory_name + '-' +
      this.model.electronic_merk_name + '-' + this.model.electronic_model_name;
  ...
  btnLookupSub() {
    ...
    $('#datatableLookupSub').DataTable({
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        dtParameters.paramTamp.push({
          'default': '',
          'p_electronic_category_code': this.model.electronic_category_code
        });
  ...
  btnSelectRowSub(code: String, description: String) {
    this.model.electronic_subcategory_code = code;
    this.model.electronic_subcategory_name = description;
    this.model.electronic_model_name = undefined;
    this.model.electronic_model_code = undefined;
    this.model.electronic_name = this.model.electronic_category_name + '-' + this.model.electronic_subcategory_name + '-' +
      this.model.electronic_merk_name + '-' + this.model.electronic_model_name;
  ...
  btnSelectRowCategory(code: String, description: String) {
    this.model.electronic_category_code = code;
    this.model.electronic_category_name = description;
    this.model.electronic_subcategory_name = undefined;
    this.model.electronic_model_name = undefined;
    this.model.electronic_subcategory_code = undefined;
    this.model.electronic_model_code = undefined;
    this.model.electronic_name = this.model.electronic_category_name + '-' + this.model.electronic_subcategory_name + '-' +
      this.model.electronic_merk_name + '-' + this.model.electronic_model_name;
        ...
        .subscribe(
          res => {
            ...
            if (parse.result === 1) {
              this.showSpinner = false;
              this.showNotification('bottom', 'right', 'success');
              this.route.navigate(['/electronic/subunitlist/unitdetail', parse.code]);
            } else {
              this.showSpinner = false;
              this.swalPopUpMsg(parse.data)
            }
  ...
  //#region button back
  btnBack() {
    this.route.navigate(['/electronic/subunitlist']);
    $('#datatableElectronicUnitList').DataTable().ajax.reload();
  }
