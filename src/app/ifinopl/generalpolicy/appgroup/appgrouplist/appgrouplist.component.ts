...
@Component({
  moduleId: module.id,
  selector: 'app-root',
  templateUrl: './appgrouplist.component.html'
})

export class AppgrouplistComponent extends BaseComponent implements OnInit {
  // variable
  ...
  //#region button add
  btnAdd() {
    this.route.navigate(['/generalpolicy/subappgrouplist/appgroupdetail']);
  }
  //#endregion button add

  //#region button edit
  btnEdit(codeEdit: string) {
    this.route.navigate(['/generalpolicy/subappgrouplist/appgroupdetail', codeEdit]);
  }
