...
export class FacilitylistComponent extends BaseComponent implements OnInit {
  // variable
    ...
    this.dtOptions = {
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRows).subscribe(resp => {
          ...
          this.listfacility = parse.data;
          if (parse.data != null) {
            this.listfacility.numberIndex = dtParameters.start;
          }
          callback({
            draw: parse.draw,
  ...
  //#region button add/
  btnAdd() {
    this.route.navigate(['/generalpolicy/subfacilitylist/facilitydetail']);
  }
  //#endregion button add

  //#region button edit
  btnEdit(codeEdit: string) {
    this.route.navigate(['/generalpolicy/subfacilitylist/facilitydetail', codeEdit]);
  }
