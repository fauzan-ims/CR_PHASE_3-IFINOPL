...
@Component({
  moduleId: module.id,
  selector: 'app-root',
  templateUrl: './masterbudgetlist.component.html'
})

export class MasterbudgetlistComponent extends BaseComponent implements OnInit {
  // variable
  ...
  //#region button add
  btnAdd() {
    this.route.navigate(['/generalpolicy/subbudgetlist/budgetdetail']);
  }
  //#endregion button add

  //#region button edit
  btnEdit(codeEdit: string) {
    this.route.navigate(['/generalpolicy/subbudgetlist/budgetdetail', codeEdit]);
  }
