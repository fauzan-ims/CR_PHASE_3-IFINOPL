...
@Component({
  moduleId: module.id,
  selector: 'app-root',
  templateUrl: './masterbudgetmaintenancelist.component.html'
})

export class MasterbudgetmaintenancelistComponent extends BaseComponent implements OnInit {
  // variable
  public listbudgetmaintenance: any = [];
    ...
    this.dtOptions = {
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRows).subscribe(resp => {
          ...
          this.listbudgetmaintenance = parse.data;
          if (parse.data != null) {
            this.listbudgetmaintenance.numberIndex = dtParameters.start;
          }
          callback({
            draw: parse.draw,
