...
@Component({
  moduleId: module.id,
  selector: 'app-root',
  templateUrl: './masterbudgetregistrationdetaildetail.component.html'
})

export class MasterbudgetregistrationdetaildetailComponent extends BaseComponent implements OnInit {
  // get param from url
        ...
        .subscribe(
          res => {
            ...
            if (parse.result === 1) {
              this.showSpinner = false;
              this.showNotification('bottom', 'right', 'success');
              this.route.navigate(['/generalpolicy/subbudgetregistrationlist/budgetregistrationdetaildetail', this.param, parse.id]);
            } else {
              this.showSpinner = false;
              this.swalPopUpMsg(parse.data);
            }
  ...
  //#region button back
  btnBack() {
    this.route.navigate(['/generalpolicy/subbudgetregistrationlist/budgetregistrationdetail', this.param]);
