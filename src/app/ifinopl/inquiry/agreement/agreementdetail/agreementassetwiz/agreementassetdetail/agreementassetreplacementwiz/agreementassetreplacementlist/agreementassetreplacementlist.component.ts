...
@Component({
  moduleId: module.id,
  selector: 'app-root',
  templateUrl: './agreementassetreplacementlist.component.html'
})

export class AgreementassetreplacementlistComponent extends BaseComponent implements OnInit {
  // get param from url
  ...
  private APIController: String = 'AgreementAssetReplacementHistory';
