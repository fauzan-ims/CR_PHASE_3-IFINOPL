...
@Component({
  moduleId: module.id,
  selector: 'app-root',
  templateUrl: './agreementassetlist.component.html'
})

export class AgreementassetlistComponent extends BaseComponent implements OnInit {
  // get param from url
  ...
  public total_lease_amount: any = 0;
  public current_total_lease_amount: any = 0;

  private APIController: String = 'AgreementAsset';
  private APIControllerApplicationMain: String = 'AgreementMain';
    ...
    this.dalservice.Getrow(this.dataTamp, this.APIControllerApplicationMain, this.APIRouteForGetRow)
      .subscribe(
        res => {
          ...
          this.total_lease_amount = parsedata.total_lease_amount;
          this.current_total_lease_amount = parsedata.current_total_lease_amount;
  ...
  btnEdit(codeEdit: string) {
    this.route.navigate(['/inquiry/subagreementlist/agreementdetail/' + this.param + '/agreementassetlist/' + this.param + '/agreementassetdetail/', this.param, codeEdit], { skipLocationChange: true });
  }
