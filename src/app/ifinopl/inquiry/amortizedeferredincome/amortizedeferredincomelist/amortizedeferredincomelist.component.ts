...
@Component({
  selector: 'app-amortizedeferredincomelist',
  templateUrl: './amortizedeferredincomelist.component.html'
})
export class AmortizedeferredincomelistComponent extends BaseComponent implements OnInit {
  // variable
  ...
  private APIRouteForGetRows: String = 'GetRowsAmortizeDeferredIncome';
  ...
  btnEdit(codeEdit: string) {
    this.route.navigate(['/inquiry/subamortizedeferredincomelist/amortizedeferredincomedetail', codeEdit]);
  }
