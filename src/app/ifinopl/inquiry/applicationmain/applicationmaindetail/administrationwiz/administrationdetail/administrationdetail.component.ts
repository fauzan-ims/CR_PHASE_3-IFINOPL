...
export class AdministrationdetailComponent extends BaseComponent implements OnInit {
  ...
  chargeswiz() {
    this.route.navigate(['/inquiry/inquiryapplicationmain/applicationmaindetail/' + this.param + '/' + this.pageType + '/administrationdetail/' + this.param + '/' + 'banberjalan' + '/chargeslist/', this.param, 'banberjalan'], { skipLocationChange: true });
  }

  documentwiz() {
    this.route.navigate(['/inquiry/inquiryapplicationmain/applicationmaindetail/' + this.param + '/' + this.pageType + '/administrationdetail/' + this.param + '/' + this.pageType + '/doclist/', this.param, this.pageType], { skipLocationChange: true });
  }
  //#endregion List tabs
}
