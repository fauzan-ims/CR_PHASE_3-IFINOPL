...
export class ApplicationmaindetailComponent extends BaseComponent implements OnInit {
  ...
  administrationwiz() {
    this.route.navigate(['/inquiry/inquiryapplicationmain/applicationmaindetail/' + this.param + '/' + this.pageType + '/administrationdetail', this.param, this.pageType], { skipLocationChange: true });
  }

  legalwiz() {
    this.route.navigate(['/inquiry/inquiryapplicationmain/applicationmaindetail/' + this.param + '/' + this.pageType + '/legaldetail', this.param, this.model.branch_code, this.pageType], { skipLocationChange: true });
  }

  surveywiz() {
    this.route.navigate(['/inquiry/inquiryapplicationmain/applicationmaindetail/' + this.param + '/' + this.pageType + '/surveydetail', this.param, this.pageType], { skipLocationChange: true });
  }

  approvalwiz() {
    this.route.navigate(['/inquiry/inquiryapplicationmain/applicationmaindetail/' + this.param + '/' + this.pageType + '/approvaldetail', this.param, this.model.level_code, this.pageType], { skipLocationChange: true });
  }
  //#endregion List tabs
