...
export class AssetdetailComponent extends BaseComponent implements OnInit {
  ...
  btnBack() {
    if (this.pageType != null) {
      this.route.navigate(['/inquiry/inquiryapplicationmain/applicationmaindetail/' + this.param + '/' + this.pageType + '/assetlist', this.param, this.pageType], { skipLocationChange: true });

    } else {
      this.route.navigate(['/inquiry/inquiryapplicationmain/applicationmaindetail/' + this.param + '/assetlist', this.param], { skipLocationChange: true });
    }
  ...
  //#region List tabs 
  amortizationwiz() {
    this.route.navigate(['/inquiry/inquiryapplicationmain/applicationmaindetail/' + this.param + '/' + this.pageType + '/assetlist/' + this.param + '/' + this.pageType + '/assetdetail/' + this.param + '/' + this.params + '/' + this.pageType + '/amortizationlist/', this.params, 'banberjalan'], { skipLocationChange: true });
  }
  //#endregion List tabs
  ...
  btnKaroseriAccessories(type: String) {
    this.route.navigate(['/inquiry/inquiryapplicationmain/applicationmaindetail/' + this.param + '/' + this.pageType + '/assetlist/' + this.param + '/' + 'banberjalan' + '/karoseriaccessorieslistinquiry/', this.param, this.params, type], { skipLocationChange: true });
  }
  //#endregion btnKaroseriAccessories

  btnInsurance() {
    this.route.navigate(['/inquiry/inquiryapplicationmain/applicationmaindetail/' + this.param + '/' + this.pageType + '/assetlist/' + this.param + '/' + 'banberjalan' + '/assetinsurancedetaildetail/', this.param, this.params], { skipLocationChange: true });
  }
