...
export class KaroseriaccessorieslistinquiryComponent extends BaseComponent implements OnInit {
  ...
  //#region btn back
  btnBack() {
    this.route.navigate(['/inquiry/inquiryapplicationmain/applicationmaindetail/' + this.appNo + '/' + 'banberjalan' + '/assetlist/' + this.appNo + '/' + 'banberjalan' + '/assetdetail/', this.appNo, this.assetNo, 'banberjalan'], { skipLocationChange: true });
