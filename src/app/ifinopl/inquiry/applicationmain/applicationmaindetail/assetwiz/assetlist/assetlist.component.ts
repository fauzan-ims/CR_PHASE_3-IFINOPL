...
export class AssetlistComponent extends BaseComponent implements OnInit {
  ...
  //#region button add
  btnAdd() {
    this.route.navigate(['/inquiry/subapplicationmainlist/applicationmaindetail/' + this.param + '/assetlist/' + this.param + '/assetdetail/', this.param], { skipLocationChange: true });
  }
  //#endregion button add

  //#region button edit
  btnEdit(codeEdit: string) {
    this.route.navigate(['/inquiry/inquiryapplicationmain/applicationmaindetail/' + this.param + '/' + this.pageType + '/assetlist/' + this.param + '/' + 'banberjalan' + '/assetdetail/', this.param, codeEdit, 'banberjalan'], { skipLocationChange: true });
  }
