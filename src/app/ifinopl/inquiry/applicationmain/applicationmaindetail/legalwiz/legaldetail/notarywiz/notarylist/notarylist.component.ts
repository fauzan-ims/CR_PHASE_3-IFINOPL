...
export class NotarylistComponent extends BaseComponent implements OnInit {
  ...
  btnEdit(codeEdit: string) {
    this.route.navigate(['/inquiry/inquiryapplicationmain/applicationmaindetail/' + this.param + '/' + this.pageType + '/legaldetail/' + this.param + '/' + this.branch + '/' + 'banberjalan' + '/notarydetail/', this.param, codeEdit, this.branch, 'banberjalan'], { skipLocationChange: true });
  }
