...
export class FinancialrecapitulationlistComponent extends BaseComponent implements OnInit {
  ...
  btnEdit(codeEdit: string) {
    this.route.navigate(['/inquiry/inquiryapplicationmain/applicationmaindetail/' + this.param + '/' + this.pageType + '/surveydetail/' + this.param + '/banberjalan' + '/financialrecapitulationdetail/', this.param, codeEdit, 'banberjalan'], { skipLocationChange: true });
  }
