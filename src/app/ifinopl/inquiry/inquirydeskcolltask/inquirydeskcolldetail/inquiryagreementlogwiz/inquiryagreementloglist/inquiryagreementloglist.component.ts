...
@Component({
  moduleId: module.id,
  selector: 'app-root',
  templateUrl: './inquiryagreementloglist.component.html'
})

export class InquiryAgreementloglistComponent extends BaseComponent implements OnInit {
  // get param from url
