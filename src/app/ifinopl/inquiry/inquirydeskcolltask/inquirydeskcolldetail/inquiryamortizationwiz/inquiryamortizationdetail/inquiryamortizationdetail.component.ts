...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './inquiryamortizationdetail.component.html'
})

export class InquiryAmortizationdetailComponent extends BaseComponent implements OnInit {
    // get param from url
    ...
    private APIRouteForGetRowInquiryDeskcollInvoice: String = 'GetRowInquiryDeskcollInvoice';
    private APIRouteForUpdate: String = 'UPDATE';
    private APIRouteForLookup: String = 'GetRowsForLookup';
    private APIRouteForGetRowsAgreement: String = 'GetRowsAgreement';
    private APIRouteForGetRowsInquiryDeskcollInvoiceAgreement: String = 'GetRowsInquiryDeskcollInvoiceAgreement';
    private APIRouteForGetRowForInquiryDeskcollMain: String = 'GetRowForInquiryDeskcollMain';

    private RoleAccessCode = 'R00024780000001A'; // role access 
    ...
    callGetrow() {
        ...
        this.dataTamp = [{
            'p_id': Number(this.params),
            'p_invoice_no': this.params,
        }];

        this.dalservice.Getrow(this.dataTamp, this.APIController, this.APIRouteForGetRowInquiryDeskcollInvoice)
            .subscribe(
                res => {
    ...
    callGetrowHeader() {
        ...
        this.dalservice.Getrow(this.dataTamp, this.APIControllerHeader, this.APIRouteForGetRowForInquiryDeskcollMain)
            .subscribe(
                res => {
                    const parse = JSON.parse(res);
                    const parsedata = this.getrowNgb(parse.data[0]);
    ...
    //#region button back
    btnBack() {
        this.route.navigate(['/inquiry/inquirydeskcolltaskdetailpast/' + this.param + '/inquiryamortizationlist', this.param]);
    ...
    loadData() {
        this.dtOptions = {
            ...
            ajax: (dtParameters: any, callback) => {
                ...
                this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRowsInquiryDeskcollInvoiceAgreement).subscribe(resp => {
    ...
    btnSelectRowMasterDeskcollResult(Code: String, Name: String) {
        ...
        this.model.result_detail_code = '';
        this.model.result_detail_name = '';
