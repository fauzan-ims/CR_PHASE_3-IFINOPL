...
@Component({
  moduleId: module.id,
  selector: 'app-root',
  templateUrl: './inquirydeskcolltaskpastduelist.component.html'
})

export class InquiryDeskcolltasktpastduelistComponent extends BaseComponent implements OnInit {
  // get param from url
