...
export class PaymentrequestdetailComponent extends BaseComponent implements OnInit {
    ...
    private RoleAccessCode = 'R00020850000000A';

    // API Controller
    private APIController: String = 'OplInterfacePaymentRequest';
    private APIControllerFinInterfacePaymentRequestDetail: String = 'OplInterfacePaymentRequestDetail';
