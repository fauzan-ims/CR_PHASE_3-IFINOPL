...
export class UnitdetailComponent extends BaseComponent implements OnInit {
  ...
  private APIController: String = 'MasterMachineryUnit';
  private APIControllerCategory: String = 'MasterMachineryCategory';
  private APIControllerSub: String = 'MasterMachinerySubcategory';
  private APIControllerMerk: String = 'MasterMachineryMerk';
  private APIControllerModel: String = 'MasterMachineryModel';
  private APIControllerType: String = 'MasterMachineryType';
  ...
  private RoleAccessCode = 'R00020190000000A'; // role access 
    ...
    $('#datatableLookupType').DataTable({
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        dtParameters.paramTamp.push({
          'default': '',
          'p_machinery_model_code': this.model.machinery_model_code
        });
        
        this.dalservice.Getrows(dtParameters, this.APIControllerType, this.APIRouteLookupUnit).subscribe(resp => {
  ...
  btnSelectRowType(code: String, description: String) {
    this.model.machinery_type_code = code;
    this.model.machinery_type_name = description;
    this.model.machinery_name = this.model.machinery_category_name + '-' + this.model.machinery_subcategory_name + '-' +
      this.model.machinery_merk_name + '-' + this.model.machinery_model_name + '-' + this.model.machinery_type_name;
  ...
  btnLookupModel() {
    ...
    $('#datatableLookupModel').DataTable({
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        dtParameters.paramTamp = [];
        dtParameters.paramTamp.push({
          'p_machinery_merk_code': this.model.machinery_merk_code,
          'p_machinery_subcategory_code': this.model.machinery_subcategory_code
        });
  ...
  btnSelectRowModel(code: String, description: String) {
    this.model.machinery_model_code = code;
    this.model.machinery_model_name = description;
    this.model.machinery_type_name = undefined;
    this.model.machinery_type_code = undefined;
    this.model.machinery_name = this.model.machinery_category_name + '-' + this.model.machinery_subcategory_name + '-' +
      this.model.machinery_merk_name + '-' + this.model.machinery_model_name + '-' + this.model.machinery_type_name;
  ...
  btnSelectRowMerk(code: String, description: String) {
    this.model.machinery_merk_code = code;
    this.model.machinery_merk_name = description;
    this.model.machinery_model_code = undefined;
    this.model.machinery_type_name = undefined;
    this.model.machinery_model_name = undefined;
    this.model.machinery_type_code = undefined;
    this.model.machinery_name = this.model.machinery_category_name + '-' + this.model.machinery_subcategory_name + '-' +
      this.model.machinery_merk_name + '-' + this.model.machinery_model_name + '-' + this.model.machinery_type_name;
  ...
  btnLookupSub() {
    ...
    $('#datatableLookupSub').DataTable({
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        dtParameters.paramTamp.push({
          'default': '',
          'p_machinery_category_code': this.model.machinery_category_code
        });
  ...
  btnSelectRowSub(code: String, description: String) {
    this.model.machinery_subcategory_code = code;
    this.model.machinery_subcategory_name = description;
    this.model.machinery_model_code = undefined;
    this.model.machinery_type_name = undefined;
    this.model.machinery_model_name = undefined;
    this.model.machinery_type_code = undefined;
  ...
  btnSelectRowCategory(code: String, description: String) {
    this.model.machinery_category_code = code;
    this.model.machinery_category_name = description;
    this.model.machinery_subcategory_name = undefined;
    this.model.machinery_model_name = undefined;
    this.model.machinery_type_name = undefined;
    this.model.machinery_subcategory_code = undefined;
    this.model.machinery_model_code = undefined;
    this.model.machinery_type_code = undefined;
    this.model.machinery_name = this.model.machinery_category_name + '-' + this.model.machinery_subcategory_name + '-' +
      this.model.machinery_merk_name + '-' + this.model.machinery_model_name + '-' + this.model.machinery_type_name;
        ...
        .subscribe(
          res => {
            ...
            if (parse.result === 1) {
              this.showSpinner = false;
              this.showNotification('bottom', 'right', 'success');
              this.route.navigate(['/machinery/subunitlist/unitdetail', parse.code]);
            } else {
              this.showSpinner = false;
              this.swalPopUpMsg(parse.data)
            }
  ...
  //#region button back
  btnBack() {
    this.route.navigate(['/machinery/subunitlist']);
    $('#datatableMachineryUnitList').DataTable().ajax.reload();
  }
