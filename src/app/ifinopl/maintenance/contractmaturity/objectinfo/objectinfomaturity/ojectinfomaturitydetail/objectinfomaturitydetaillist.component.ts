...
@Component({
  moduleId: module.id,
  selector: 'app-root',
  templateUrl: './objectinfomaturitydetaillist.component.html'
})

export class ObjectinfomaturitydetaillistComponent extends BaseComponent implements OnInit {
  // get param from url
  ...
  btnBack() {
    this.route.navigate(['objectinfomaturity/objectinfomaturity', this.maturityCode]);
