...
export class ReturnassetlistComponent extends BaseComponent implements OnInit {
  // variable
  public listreturnasset: any = [];
  public lookupsysbranch: any = [];
  public branch_name: String;
  public branch_code: String;
  public tampreturnassetStatus: String;
  ...
  ngOnInit() {
    ...
    this.loadData();
    this.tampreturnassetStatus = 'TERMINATE';
  }

  //#region returnassetStatus
  returnassetStatus(event) {
    this.tampreturnassetStatus = event.target.value;
    $('#datatableReturnassetlist').DataTable().ajax.reload();
  }
  //#endregion returnassetStatus
    ...
    this.dtOptions = {
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        dtParameters.paramTamp.push({
          ...
          'p_agreement_status': this.tampreturnassetStatus
        })
        
        this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRows).subscribe(resp => {
          const parse = JSON.parse(resp)
          this.listreturnasset = parse.data;
          if (parse.data != null) {
            this.listreturnasset.numberIndex = dtParameters.start;
          }
          callback({
            draw: parse.draw,
  ...
  btnEdit(codeEdit: String) {
    this.route.navigate(['/maintenance/subreturnassetlist/returnassetdetail', codeEdit]);
  }
