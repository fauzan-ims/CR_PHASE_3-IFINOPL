...
@Component({
  moduleId: module.id,
  selector: 'app-root',
  templateUrl: './chargeswaivelist.component.html'
})

export class ChargeswaivelistComponent extends BaseComponent implements OnInit {
  // variable
  public listchargeswaive: any = [];
    ...
    this.dtOptions = {
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        dtParameters.paramTamp.push({
          ...
          'p_waived_status': this.tampStatus
        });


        this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRows).subscribe(resp => {
          const parse = JSON.parse(resp)
          this.listchargeswaive = parse.data;
          if (parse.data != null) {
            this.listchargeswaive.numberIndex = dtParameters.start;
          }
  ...
  //#region button add
  btnAdd() {
    this.route.navigate(['/management/subchargeswaivelist/chargeswaivedetail']);
  }
  //#endregion button add

  //#region button edit
  btnEdit(codeEdit: string) {
    this.route.navigate(['/management/subchargeswaivelist/chargeswaivedetail', codeEdit]);
  }
