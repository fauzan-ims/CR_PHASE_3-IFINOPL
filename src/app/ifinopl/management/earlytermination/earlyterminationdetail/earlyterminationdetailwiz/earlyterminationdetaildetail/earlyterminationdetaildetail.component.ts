...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './earlyterminationdetaildetail.component.html'
})

export class EarlyterminationdetaildetailComponent extends BaseComponent implements OnInit {
    // get param from url
    ...
    private APIRouteForGetRows: String = 'GetRowsForET';
    ...
    //#region button back
    btnBack() {
        this.route.navigate(['/management/subearlyterminationlist/earlyterminationdetail/' + this.param + '/earlyterminationdetaillist', this.param]);
        $('#datatabledetail').DataTable().ajax.reload();
    }
