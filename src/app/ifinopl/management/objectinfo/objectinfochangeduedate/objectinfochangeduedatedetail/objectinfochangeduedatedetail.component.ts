...
@Component({
  moduleId: module.id,
  selector: 'app-root',
  templateUrl: './objectinfochangeduedatedetail.component.html'
})

export class ObjectinfochangeduedatedetailComponent extends BaseComponent implements OnInit {
  // get param from url
  param = this.getRouteparam.snapshot.paramMap.get('id1');
  code = this.getRouteparam.snapshot.paramMap.get('id2');
  ...
  //#region button back
  btnBack() {
    this.route.navigate(['/objectinfomanagement/objectinfochangeduedate/', this.code])
