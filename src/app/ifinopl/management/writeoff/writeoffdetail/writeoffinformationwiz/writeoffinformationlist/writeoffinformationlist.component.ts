...
@Component({
  moduleId: module.id,
  selector: 'app-root',
  templateUrl: './writeoffinformationlist.component.html'
})

export class WriteoffinformationlistComponent extends BaseComponent implements OnInit {
  // get param from url
  ...
  private APIController: String = 'WriteOffTransaction';
