...
@Component({
  selector: 'app-reportbillingduelist',
  templateUrl: './reportbillingduelist.component.html'
})
export class reportbillingduelistComponent extends BaseComponent implements OnInit {
  // get param from url
  ...
  //#endregion SysBranch lookup 
    ...
    //#region changeinvoice_status
  changeinvoice_status(event: any){
    this.model.invoice_status = event.target.value
  }
  //#endregion changeinvoice_status
}
