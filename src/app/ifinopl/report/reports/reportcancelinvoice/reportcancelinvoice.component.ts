...
@Component({
  selector: 'app-reportcancelinvoice',
  templateUrl: './reportcancelinvoice.component.html'
})
export class reportcancelinvoiceComponent extends BaseComponent implements OnInit {
  // get param from url
