...
@Component({
  selector: 'app-reportdailyoverduelist',
  templateUrl: './reportdailyoverduelist.component.html'
})
export class reportdailyoverduelistComponent extends BaseComponent implements OnInit {
  // get param from url
