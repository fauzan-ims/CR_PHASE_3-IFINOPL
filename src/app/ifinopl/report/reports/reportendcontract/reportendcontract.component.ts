...
@Component({
  selector: 'app-reportendcontract',
  templateUrl: './reportendcontract.component.html'
})
export class ReportendcontractComponent extends BaseComponent implements OnInit {
  // get param from url
