...
@Component({
  selector: 'app-reportinvoicelist',
  templateUrl: './reportinvoicelist.component.html'
})
export class ReportinvoicelistComponent extends BaseComponent implements OnInit {
  // get param from url
