...
@Component({
  selector: 'app-reportkontrakoverdue',
  templateUrl: './reportkontrakoverdue.component.html'
})
export class Reportkontrakoverdue extends BaseComponent implements OnInit {
  // get param from url
  ...
  private RoleAccessCode = 'R00024260000001A';
