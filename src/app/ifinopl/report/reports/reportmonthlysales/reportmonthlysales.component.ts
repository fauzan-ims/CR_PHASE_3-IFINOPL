...
@Component({
  selector: 'app-reportmonthlysales',
  templateUrl: './reportmonthlysales.component.html'
})
export class ReportmonthlysalesComponent extends BaseComponent implements OnInit {
  // get param from url
