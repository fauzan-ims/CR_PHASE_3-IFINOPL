...
@Component({
  selector: 'app-reportoutstandingni',
  templateUrl: './reportoutstandingni.component.html'
})
export class ReportoutstandingniComponent extends BaseComponent implements OnInit {
  // get param from url
