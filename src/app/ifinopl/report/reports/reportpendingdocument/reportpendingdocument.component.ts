...
@Component({
    selector: 'app-reportpendingdocument',
    templateUrl: './reportpendingdocument.component.html'
})
export class ReportpendingdocumentComponent extends BaseComponent implements OnInit {
    // get param from url
    ...
    btnLookupMarketing() {
        ...
        $('#datatableLookupMarketing').DataTable({
            ...
            ajax: (dtParameters: any, callback) => {
                ...
                // end param tambahan untuk getrows dynamic
                this.dalservice.Getrows(dtParameters, this.APIControllerAgreementMain, this.APIRouteForLookupMarketing).subscribe(resp => {
                    const parse = JSON.parse(resp);
    ...
    btnSelectRowMarketing(code: String, name: String) {
        ...
        this.model.marketing_name = name;
