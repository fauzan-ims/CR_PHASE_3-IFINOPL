...
@Component({
  selector: 'app-reportprospectfollowup',
  templateUrl: './reportprospectfollowup.component.html'
})
export class ReportProspectFollowUpComponent extends BaseComponent implements OnInit {
  // get param from url
