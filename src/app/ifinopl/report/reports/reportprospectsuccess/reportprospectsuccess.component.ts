...
@Component({
  selector: 'app-reportprospectsuccess',
  templateUrl: './reportprospectsuccess.component.html'
})
export class ReportProspectSuccessComponent extends BaseComponent implements OnInit {
  // get param from url
  ...
  btnSelectRowSysBranch(code: String, description: String) {
    ...
    this.model.marketing_code = undefined;
    this.model.marketing_name = undefined;
