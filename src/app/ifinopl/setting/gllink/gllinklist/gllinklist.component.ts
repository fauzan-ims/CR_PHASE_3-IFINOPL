...
export class GllinklistComponent extends BaseComponent implements OnInit {
  ...
  private RoleAccessCode = 'R00016950000010A'; // role access 
  ...
  //#region button add
  btnAdd() {
    this.route.navigate(['/setting/subgllinklist/gllinkdetail']);
  }
  //#endregion button add

  //#region button edit
  btnEdit(codeEdit: string) {
    this.route.navigate(['/setting/subgllinklist/gllinkdetail', codeEdit]);
  }
