...
export class LeadslistComponent extends BaseComponent implements OnInit {
  // variable
  ...
  private APIRouteForGetRowsLeads: String = 'GetRowsLeads';
  ...
  loadData() {
    this.dtOptions = {
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRowsLeads).subscribe(resp => {
          const parse = JSON.parse(resp)
          this.listleads = parse.data;

          if (parse.data != null) {
            this.listleads.numberIndex = dtParameters.start;
          }
  ...
  btnEdit(codeEdit: string) {
    this.route.navigate(['/transaction/subleadslist/leadsdetail', codeEdit]);
  }
