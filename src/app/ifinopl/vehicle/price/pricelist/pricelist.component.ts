...
export class PricelistComponent extends BaseComponent implements OnInit {
  ...
  public asset_year: any = [];
  public lookupCategory: any = [];
  public lookupSub: any = [];
  public lookupMerk: any = [];
  public lookupModel: any = [];
  public lookupType: any = [];
  public vehicle_merk_code: String;
  public vehicle_category_code: String;
  public vehicle_subcategory_code: String;
  public vehicle_model_code: String;
  public vehicle_type_code: String;
  ...
  ngOnInit() {
    ...
    this.asset_year = undefined;
    this.vehicle_category_code = undefined;
    this.vehicle_subcategory_code = undefined;
    this.vehicle_merk_code = undefined;
    this.vehicle_model_code = undefined;
    this.vehicle_type_code = undefined;
    this.loadData();
  }

  //#region Year
  Year(event: any) {
    this.asset_year = event.target.value;
    ...
    $('#datatableLookupType').DataTable({
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        dtParameters.paramTamp.push({
          'p_vehicle_model_code': this.vehicle_model_code
        });
  ...
  btnLookupModel() {
    ...
    $('#datatableLookupModel').DataTable({
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        dtParameters.paramTamp = [];
        dtParameters.paramTamp.push({
          'p_vehicle_subcategory_code': this.vehicle_subcategory_code,
          'p_vehicle_merk_code': this.vehicle_merk_code
        });
  ...
  btnLookupSub() {
    ...
    $('#datatableLookupSub').DataTable({
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        dtParameters.paramTamp = [];
        dtParameters.paramTamp.push({
          'p_vehicle_category_code': this.vehicle_category_code
        });
  ...
  btnSelectRowSub(code: String, description: String) {
    this.vehicle_subcategory_code = code;
  ...
  btnSelectRowCategory(code: String, description: String) {
    this.vehicle_category_code = code;
    ...
    this.dtOptions = {
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        dtParameters.paramTamp.push({
          ...
          'p_vehicle_merk_code': this.vehicle_merk_code,
          'p_vehicle_model_code': this.vehicle_model_code,
          'p_vehicle_type_code': this.vehicle_type_code,
          'p_asset_year': this.asset_year
        })
  ...
  //#region button add
  btnAdd() {
    this.route.navigate(['/vehicle/subpricelist/pricedetail']);
  }
  //#endregion button add

  //#region button add
  btnUpload() {
    this.route.navigate(['/vehicle/subpricelist/priceupload']);
  }
  //#endregion button add

  //#region button edit
  btnEdit(codeEdit: string) {
    this.route.navigate(['/vehicle/subpricelist/pricedetail', codeEdit]);
  }
